...
export const Navigation = ({ heading, showMode, setShowMode, sectors, services }) => {
  ...
  useEffect(() => {
    ...
    if (navigationItems.hasOwnProperty(showMode)) setCurrentNavigation(navigationItems[showMode]);

...
export const StatsCircle: React.FC<Props> = ({ number }) => {
  return (
    <svg
    ...
    >
      <circle
        ...
        cx="96"
        cy="96"
        strokeDashoffset={560 - ((number > 100 ? 100 : number) / 100) * 560}
        className={styles.progressCircle}
        stroke={'url(#paint0_linear_1639_80025)'}
      />
      ...
      <defs>
        ...
        >
          <stop stopColor="#300032" stopOpacity="0" />
          <stop offset=".5" stopColor="#300032" />
          <stop offset="1" stopColor="#300032" stopOpacity="0" />
        </linearGradient>
        <linearGradient
          xmlns="http://www.w3.org/2000/svg"
          id="b"
